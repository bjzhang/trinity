...
long JC_SyS_fstatfs64(unsigned int fd, compat_size_t sz, struct compat_statfs64 __user *buf)
{
printk("parameter value:sz<%u>, fd<%u>, buf<%u>", sz, fd, buf);
printk
...
.entry                  = JC_SyS_fstatfs64,
.kp = {
.symbol_name    = "compat_sys_fstatfs64",
},
};
