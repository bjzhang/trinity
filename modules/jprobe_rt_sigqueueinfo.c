...
long JC_SyS_rt_sigqueueinfo(int sig, struct compat_siginfo *uinfo, int pid)
{
printk("parameter value:sig<%u>, uinfo<%u>, pid<%u>", sig, uinfo, pid);
printk
...
.entry                  = JC_SyS_rt_sigqueueinfo,
.kp = {
.symbol_name    = "compat_sys_rt_sigqueueinfo",
},
};
